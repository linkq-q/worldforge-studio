...
api.environmentSample([x,z],{guideIds?:string[],region?:circle|path|polygon}) returns x,z,height,slope,waterDistance,guideDistance and signed regionDistance when region is requested; negative regionDistance is inside.
...
- api.routeNetwork returns a string[] of route IDs in edge order.
